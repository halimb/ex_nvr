defmodule ExNVRWeb.FlopConfig do
  ...
  def table_opts do
    [
      ...
      thead_attrs: [
        class: "text-xs text-black uppercase bg-primary-400 dark:bg-gray-700 dark:text-gray-400"
      ],
      thead_th_attrs: [class: "px-6 py-3 relative p-0 pb-2 text-center"],
      tbody_tr_attrs: [
        class:
          "text-black bg-gray-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-primary-200 dark:text-gray-400"
      ],
